#!/usr/bin/env python3
"""Seal generated v3 inputs without enabling paid calls."""
...
from benchmarks.scripts.confirmatory_v3_lock import LOCK_PATH, computed_seal, load_json
...
def main() -> None:
    ...
    print(f"Sealed BehaviorBench v3 lock with {len(seal['includedTaskIds'])} tasks; paid calls remain disabled.")
