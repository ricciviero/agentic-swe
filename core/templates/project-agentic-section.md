...
- For an unconfigured repository, use `agents-setup` before onboarding or non-trivial implementation work.
- For non-trivial work, use `iterations-planner` before editing. Local records live in the configured iteration and fix directories and remain gitignored unless this repository explicitly says otherwise.
