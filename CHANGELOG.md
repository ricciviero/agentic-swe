...
- Pure `@agentic-swe/core` evaluator and read-only `@agentic-swe/node` repository adapter.
- `@agentic-swe/cli` commands for inspection, evaluation, verification, diagnostics, rendering, safe installation, and safe removal.
